...
const (
	...
	MergeFinishedFileName = "merge-finish"
...
// OpenMergeFinishedFile 打开标识 merge 完成文件
...
func (df *DataFile) ReadLogRecord(offset int64) (*LogRecord, int64, error) {
	...
	var headerBytes int64 = maxLogRecordHearderSize
	if offset+maxLogRecordHearderSize > fileSize {
